                                        ...
                                        <table className='table table-bordered table-hover'>
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th className='text-nowrap'>COURSE NAME</th>
                                                    ...
                                                    paginatedList.map((val, key) => (
                                                        <tr key={key}>
                                                            ...
                                                            <td className='text-nowrap'>
                                                                <Tooltip title="Edit" onClick={()=> setTimeout(() => { navigate(`/pn/certificate-edit/${val?.certificate_id}`) }, 300)}>
                                                                    <IconButton>
                                                            ...
                                                            <td className='text-nowrap'>{val.course}</td>
